...
quizzes = [f for f in os.listdir("/Users/adfer11/Desktop/Codenation/python/learning_python/codenation_python_with_ai/week_5/quiz_game/quiz_game_python_main") if not f.startswith('.')]


# Filter out any file that starts with a dot
